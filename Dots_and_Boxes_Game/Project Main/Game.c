...
int main()
{
    ...
    scanf(" %s",&o);
    o[0]=(int)o[0]-48;
    while(o[0]!=1 && o[0]!=2 && o[0]!=3 && o[0]!=4|| (int)o[1]>=33 && (int)o[1]<=127)
    {
    ...
    if(o[0]==1)
    {
        ...
        // --------------------------------- Player_B's_Turn ------------------------------------------
            ...
            Print_Who_Won(Current_Game,Player_A_Name,Player_B_Name);
        ...
        // --------------------------------- Player_B's_Turn ------------------------------------------
            ...
            A_Print_Who_Won(A_Current_Game,A_Player_A_Name,A_Player_B_Name);
    ...
    if (o[0]==2)
    {
        ...
        // --------------------------------- Player_B's_Turn ------------------------------------------
            ...
            Print_Who_Won(Current_Game,PVC_Beginner_Player_A_Name,"Computer");
            Import_Beginner_Top_10_List();
        ...
        // --------------------------------- Player_B's_Turn ------------------------------------------
            ...
            A_Print_Who_Won(A_Current_Game,PVC_Advanced_Player_A_Name,"Computer");
            Import_Advanced_Top_10_List();
    ...
    if(o[0]==4)
    {
        printf(CYAN"Exit Option Has been chosen.\nGame Closed.\n"RESET);
    }
    return 0;
}
